...
(Ans) - When promotions are used, sale quantity of items can be more but on the other hand sales revenue may be less because of the promotions applied thus using items sold (sales volume) is a more reliable target variable for this problem. 
A promotion may sell more items but generate lower revenue.
